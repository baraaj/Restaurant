...
<body>
<div style=" background-image: url('images/restu.jpg');
object-fit:cover;
         ...
         <div class="page-wrapper">
            ...
            <section class="contact-page inner-page">
               <div class="container">
                  <div class="row">
                     <div class="col-md-8">
                        <div class="widget" style="margin-left:27%; width:800px" >
                           <div class="widget-body"style="padding:50px;">
                            
							  <form action="" method="post">
                                 <div class="row">
                                    <div><h1 style="text-align:center">Welcome to tasty! </h1></div>
