...
function check_dimanche($value) {
        ...
        $date = trim($date);
        if (strstr($date,"Monday")) return 1;
        else return 0;
        }
...
if(empty($_SESSION["user_id"]))
{
	header('location:login.php');
                                                ...
                                                if(check_dimanche( date("l"))){
                                                    $item_total*=0.5;
                                                }
													if($_POST['submit'])
													{
						
													$SQL="insert into users_orders(u_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]*0.5."')";
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> <?php echo "dt".$item_total; ?></strong></td>
                                                    </tr>
                                                </tbody>
