...
<body class="home">
        ...
        <div> <marquee style="font-size: x-large;" behavior=alternate><b><i>50% Discount every Monday</i></b></marquee></div>
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">'.$r['price'].'dt</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
